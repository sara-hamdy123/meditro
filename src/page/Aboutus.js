...
import circleblue from "../assets/line-circle-blue.png";
import waveorange from "../assets/wave-orange.png";
import squareorang from "../assets/square-dots-orange.png";
import circlesmallblue from "../assets/circle-small-blue.png";
import "./Aboutus.css";
...
<div className="container">
    ...
    <div className="col-md-6 col-sm-12 mb-30">
        ...
        <div className="row">
            <div className="col-md-6 col-sm-6 mb-30 mb-sm-20">
        ...
        <img src={circleblue} alt="" className="circleblue" />
        <img src={circlesmallblue} alt="" className="circlesmallblue" />
        <img src={squareorang} alt="" className="squareorang" />
    </div>
    </div>
</div>
</section>
