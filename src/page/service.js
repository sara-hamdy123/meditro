...
import squaredot from "../assets/square-dots-orange.png";
import waveblue from "../assets/wave-blue.png";
import squarerot from "../assets/square-rotate.png";
...
<section className="service-wraper">
        ...
        <div className="row align-items-center">
            <div className=" col-xl-4 col-lg-7  ">
                <div className="heading-box">
                    <h6 className="title-top">Services</h6>
                ...
                <a href="/" className="btn-ser">All Services</a>
            </div>
            <div className="col-xl-8 mb-15">
                <div className="swiper-container">
                    <div className="swiper-wraper">
                        <div className="swiper-slide  swiper-slide-active">
                        <div className="feature-container feature-bx2 feature-1">
                        ...
                        <div className="feature-container feature-bx2 feature-2">
                        <div className="feature-box-xl mb-30">
                        <span className="icon-cell">
                        <svg enableBackground="new 0 0 512 512" height="80" viewBox="0 0 512 512" width="80" xmlns="http://www.w3.org/2000/svg">
												<g fill="#020288">
                        ...
                        <div className="swiper-slide  swiper-slide-next">
                        <div className="feature-container feature-bx2 feature-3">
                        <div className="feature-box-xl mb-30">
                        <span className="icon-cell">
                        <svg enableBackground="new 0 0 512 512" height="80" viewBox="0 0 512 512" width="80" xmlns="http://www.w3.org/2000/svg">
    ...
    <img src={linecircleblue} alt=""  className="img1"/>
    <img src={squaredot} alt="" className="img2" />
    <img src={waveblue} alt="" className="img3" />
    <img src={squarerot} alt="" className="img4" />
</section>
)
}
